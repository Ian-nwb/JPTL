  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4 my-4 sm:my-6">
      ...
      <div className="group relative top-shade apple-glass rounded-2xl border border-slate-200 dark:border-slate-800/80 p-3.5 sm:p-5 transition-all hover:border-indigo-500/50 dark:hover:border-indigo-500/30 overflow-hidden flex flex-col justify-between">
        ...
        <div className="mt-2.5 sm:mt-4 flex items-end gap-1 h-5 sm:h-7 pt-1 border-t border-slate-100 dark:border-slate-800/60">
      ...
      <div className="group relative top-shade apple-glass rounded-2xl border border-slate-200 dark:border-slate-800/80 p-3.5 sm:p-5 transition-all hover:border-indigo-500/50 dark:hover:border-indigo-500/30 overflow-hidden flex flex-col justify-between">
        <div>
          ...
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-extrabold font-grotesk text-slate-900 dark:text-white tracking-tight">
            {occupiedUnits} <span className="text-xs sm:text-sm font-normal text-slate-500 dark:text-slate-400">/ {totalUnits}</span>
          </h3>
        </div>

        <div className="mt-2.5 sm:mt-3 space-y-1 sm:space-y-1.5">
          <div className="h-1.5 sm:h-2 w-full rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden flex">
            <div 
