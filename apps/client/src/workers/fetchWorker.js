 ...
 * Offloads concurrent HTTP network requests and JSON deserialization off the main UI thread.
 * Compatible with Vite bundler, Bun runtime, and Vercel edge/static hosting.
 */
