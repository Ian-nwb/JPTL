...
- Name: e2e.spec.js >> E2E Test Suite — JPTL Property Management Platform >> 1. Authentication & Access Control >> 1.2 Should show error when attempting login with invalid credentials
- Location: tests/e2e.spec.js:13:9
...
Locator: locator('text=/Invalid email or password|Authentication failed|Invalid credentials/i')
Expected: visible
Error: strict mode violation: locator('text=/Invalid email or password|Authentication failed|Invalid credentials/i') resolved to 2 elements:
    1) <span class="font-bold block">Authentication Failed</span> aka getByText('Authentication Failed')
    2) <span>Invalid email or password</span> aka getByText('Invalid email or password')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=/Invalid email or password|Authentication failed|Invalid credentials/i')
...
- generic [ref=e3]:
  - generic [ref=e4]:
    - generic [ref=e5]:
      - link "JPTL.SYSTEM" [ref=e6] [cursor=pointer]:
        - /url: /
      - button "Toggle Light/Dark Theme" [ref=e13]
    - generic [ref=e16]:
      - heading "Welcome Back." [level=1] [ref=e21]
      - paragraph [ref=e22]: Unified access for landlords and residents. Sign in with your email and password to automatically access your management dashboard or resident portal.
      - generic [ref=e23]:
        - generic [ref=e24]:
          - generic [ref=e25]: 2,480+
          - text: Managed Units
        - generic [ref=e26]:
          - generic [ref=e27]: 98.4%
          - text: Occupancy Rate
    - generic [ref=e28]: JPTL Unified Portal • Secure Authentication
  - generic [ref=e29]:
    - generic [ref=e30]:
      - generic [ref=e31]:
        - heading "Sign In to Your Account" [level=2] [ref=e32]
        - paragraph [ref=e33]: Enter your credentials below to access your portal
      - generic [ref=e37]:
        - generic [ref=e38]: Authentication Failed
    ...
    - generic [ref=e55]:
      - generic [ref=e56]:
        ...
        - button "Create one now" [ref=e57]
      - generic [ref=e58]: Resident access is granted by your landlord or property management office.
```
